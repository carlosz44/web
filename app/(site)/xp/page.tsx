  ...
  return (
    <div className="flex w-full flex-col space-y-6 md:container">
      ...
      <div className="grid grid-cols-3 gap-6 lg:gap-12">
        <div className="animate-fade-up col-span-3 px-4 sm:px-0 lg:col-span-1">
          <SkillsBlock skills={languages} />
        </div>
        <div className="animate-fade-up col-span-3 px-4 [animation-delay:80ms] sm:px-0 lg:col-span-1">
          <SkillsBlock skills={front} />
        </div>
        <div className="animate-fade-up col-span-3 px-4 [animation-delay:160ms] sm:px-0 lg:col-span-1">
