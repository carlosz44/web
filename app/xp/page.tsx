  ...
  return (
    <div className="flex w-full flex-col space-y-6 md:container">
      ...
      <div className="grid grid-cols-3 gap-6 lg:gap-12">
        <div className="col-span-3 animate-fade-in-left px-4 sm:px-0 lg:col-span-1">
          <SkillsBlock skills={langs} />
        </div>
        <div className="col-span-3 animate-fade-in-left px-4 [animation-delay:1s] sm:px-0 lg:col-span-1">
          <SkillsBlock skills={front} />
        </div>
        <div className="col-span-3 animate-fade-in-left px-4 [animation-delay:2s] sm:px-0 lg:col-span-1">
